...
DEFAULT_TEXT = "Provide a full and complete Dialogue script, and the story should be in Hindi language but word in English alphabets."
...
def search():
    ...
    if search_query:
        ...
        error_msg = "Failed to generate Dialogue content. Please try again."
        return render_template('index.html', error=error_msg)
    else:
        error_msg = "Please enter a valid Dialogue prompt."
        return render_template('index.html', error=error_msg)
